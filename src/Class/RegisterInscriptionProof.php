...
/**
 * SDK for ARCA Register Inscription Proof (ws_sr_constancia_inscripcion)
 **/

class RegisterInscriptionProof extends ArcaWebService {
	...
	**/
	...
	{
		$ta = $this->arca->GetServiceTA('ws_sr_constancia_inscripcion');
		
		$params = array(
			'token' 			=> $ta->token,
			'sign' 				=> $ta->sign,
			'cuitRepresentada' 	=> $this->arca->CUIT,
