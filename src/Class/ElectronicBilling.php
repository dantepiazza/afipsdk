...
use ArcaSdk\ArcaWebService;

/**
 * SDK for ARCA Electronic Billing (wsfe1)
 * 
...
class ElectronicBilling extends ArcaWebService {
	 ...
	 * 	ARCA {@see WS Specification item 4.1.3}
	**/
	public function CreateVoucher($data, $return_response = FALSE): array
	{
		$req = array(
			'FeCAEReq' => array(
				'FeCabReq' => array(
	 ...
	 *
	 * This method combines Arca::GetLastVoucher and Arca::CreateVoucher
	 * for create the next voucher
	 *
	 * @since 0.7
	 *
	 * @param array $data Same to $data in Arca::CreateVoucher except that
	 * 	don't need CbteDesde and CbteHasta attributes
	 * 
	 * @param bool $return_response if is TRUE returns complete response  
	 * 	from ARCA
	 *
	 * @return object if $return_response is set to false returns 
	...
	**/
	public function CreateNextVoucher($data, $return_response = FALSE): array
	{
	 ...
	 *
	 * Asks to ARCA servers for complete information of voucher {@see WS 
	...
	**/
	 ...
	 * Create CAEA 
	 * 
	 * Send a request to ARCA servers  to create a CAEA
	 *
	 ...
	 * Get CAEA 
	 * 
	 * Ask to ARCA servers for a CAEA information
	 *
	 * @param int $period 		Time period
	 * @param int $fortnight	Monthly fortnight (1 or 2)
	 **/
	...
	**/
	...
	/**
	 * Asks to ARCA Servers for voucher types availables {@see WS 
	...
	**/
	...
	/**
	 * Asks to ARCA Servers for voucher concepts availables {@see WS 
	...
	**/
	...
	/**
	 * Asks to ARCA Servers for document types availables {@see WS 
	...
	**/
	...
	/**
	 * Asks to ARCA Servers for aliquot availables {@see WS 
	...
	**/
	...
	/**
	 * Asks to ARCA Servers for currencies availables {@see WS 
	...
	**/
	...
	/**
	 * Asks to ARCA Servers for voucher optional data available {@see WS 
	...
	**/
	...
	/**
	 * Asks to ARCA Servers for tax availables {@see WS 
	...
	**/
	...
	/**
	 * Change date from ARCA used format (yyyymmdd) to yyyy-mm-dd
	 *
	 * @since 0.7
	 *
	...
	**/
	...
	private function GetWSInitialRequest($operation)
	{
		...
		$ta = $this->arca->GetServiceTA('wsfe');
	 ...
	 * @param mixed 	$results 	ARCA response
	 *
